...
public class User implements Comparable<User> {
	...
	private static final int MAX_ID_SEPARATION = 10;
	...
	public User(String firstName, String lastName, String username, String email, LocalDate joinDate) {
		...
		id = User.currentID + generator.nextInt(MAX_ID_SEPARATION);
		User.currentID = id;
	}
	...
	public String toString() {
		return firstName + "\t" + lastName + "\tID: " + id + "\tUsername: " + username + "\t(" + email + ")" + "\tJoined in: "
				+ joinDate;
	}
